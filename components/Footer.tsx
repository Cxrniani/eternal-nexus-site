    ...
    <footer className="bg-preto-opaco text-white p-10">
      <div className="max-container flex flex-col md:flex-row items-start md:items-center justify-around">
        ...
        <div className="flex-1">
          <h3 className="text-5xl font-bold ">Bem vindo a<br />
            Eternal Nexus</h3>
          <p className="text-gray-20 text-xl mb-10">
            Nunca apenas um evento.
          </p>
          <p></p>
        </div>
      ...
      <div className='max-container'>
        <p className='pt-10 text-sm'>Feito com ❤️ by Synopsy®<br />
          Copyright © 2025 Eternal Nexus. Todos os direitos reservados. </p>
      </div>
    </footer>
  )
}
